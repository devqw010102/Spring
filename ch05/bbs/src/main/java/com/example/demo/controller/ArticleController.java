...
public class ArticleController {
    ...
    @PostMapping("/add")
    public String postArticleAdd(@ModelAttribute("article") ArticleForm articleForm, @AuthenticationPrincipal MemberUserDetails userDetails, BindingResult bindingResult) {
